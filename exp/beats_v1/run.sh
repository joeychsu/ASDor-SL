...
for model_name in ${model_list} ; do
    ...
    python test.py --model_path "results/${model_name}_fixencoder/best_model.pth" \
...
for model_name in ${model_list} ; do
	...
	python test.py --model_path "results/${model_name}/best_model.pth" \
...
for seed in 905 906 907 908 909 910 911 912 913 914 ; do
	...
	python test.py --model_path "results/${model_name}_seed${seed}/best_model.pth" \
